...
import tamara.myappcompany.here.customview.OverlayView;
import tamara.myappcompany.here.env.BorderedText;
import tamara.myappcompany.here.env.ImageUtils;
import tamara.myappcompany.here.env.Logger;
...
//  //private static final String TF_OD_API_MODEL_FILE = "facenet_hiroki.tflite";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    fabAdd = findViewById(org.tensorflow.lite.examples.detection.R.id.fab_add);
...
//                    sensorOrientation, MAINTAIN_ASPECT);
    ...
    trackingOverlay = (OverlayView) findViewById(org.tensorflow.lite.examples.detection.R.id.tracking_overlay);
  ...
  protected int getLayoutId() {
    return org.tensorflow.lite.examples.detection.R.layout.camera_tracking_fragment;
  }
...
//        final int inHeight = transpose ? srcWidth : srcHeight;
  ...
  private void showAddFaceDialog(SimilarityClassifier.Recognition rec) {
    ...
    View dialogLayout = inflater.inflate(org.tensorflow.lite.examples.detection.R.layout.pop_up_dialog, null);
