...
public abstract class CameraActivity extends AppCompatActivity
  ...
  protected void onCreate(final Bundle savedInstanceState) {
    ...
    setContentView(org.tensorflow.lite.examples.detection.R.layout.camera_fragment);

    Toolbar toolbar = (Toolbar) findViewById(org.tensorflow.lite.examples.detection.R.id.toolbar);
    ...
    toolbar.setNavigationOnClickListener(new NavigationIconClickListener(
            CameraActivity.this,
            findViewById(org.tensorflow.lite.examples.detection.R.id.container2),
    ...
    btnSwitchCam = findViewById(org.tensorflow.lite.examples.detection.R.id.fab_switchcam);
